...
-- Yanking and pasting
-- Greatest remap ever paste from the deleted register
vim.keymap.set("x", "<leader>p", [["_dP]])
-- Next greatest remap ever : asbjornHaland -- yank from system clipboard
vim.keymap.set({"n", "v"}, "<leader>y", [["+y]])
vim.keymap.set("n", "<leader>Y", [["+Y]])
-- Delete into the deleted register
...
-- I think this is a find and replace for the word under cursor
